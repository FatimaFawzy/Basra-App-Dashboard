...
if( $responses['status']==1)
 ...
 <div class="success">
   ...
   <p> Order Edited successfuly</p>
   <a href="orders.php" class="btn btn-secondary add_ok"style="text-decoration: none;
font-family: serif;">Ok</a>
</div>
</div>
<?php
   }
     ...
     <div class="layout">
     <div class="success">
       <p> <?php echo $responses;?></p>
       <a href="orders.php" class="btn btn-secondary add_ok" style="text-decoration: none;
    font-family: serif;">Back</a>
    </div>
    </div>
   <?php }
}?>
