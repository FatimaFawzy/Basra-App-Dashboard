...
<span class="link" style="display:none;">../Add_Marchent.php</span>
<div class="auto-margin Ar_auto-margin">
<div class="add-merchent " style="direction: ltr;">
  <h1> اضافة تاجر</h1>
<form action="ar_Add_Marchent.php" method="post">
 <div class="row">
  <div class=" col-md-12">
  ...
  <div class="row disc input-group">
    ...
    <div class="col-md-6">
      <label class="input-label" >الوصف:</label>
          <textarea name="ar_discription" rows="5" cols="29"required></textarea>
    </div>
  </div>

  <div class="row input-group">
    <div class="col-md-12 ">
      <label class="input-label"required >Type Of Store:</label><br>
...
<div class="col-md-12" style="text-align:center;">
  <input type="submit" name="add-merchent" value="اضافة" class="submit">
</div>
...
{?>
  <div class="success">
    <p>تمت اضافة التاجر <span style="color: #5a1c08;" ><?php echo " ".$AR_name." " ; ?></span> بنجاح</p>
