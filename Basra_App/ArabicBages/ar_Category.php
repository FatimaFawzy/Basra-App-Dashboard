...
<span class="link" style="display:none;">../Category.php</span>

<div class="Ar_auto-margin auto-margin">
 <div class="category-header">
   <h3>الاقسام</h3>
   <span class="count"> يوجد <span class="cnumb"><span style="color: #e55508;"><?php echo count($category);?></span></span> قسم</span>
   ...
   <a class=" add" data-toggle="modal" data-target="#add-product">
       ...
       <span style="position:relative"> اضافة<i class="fas fa-plus-circle"></i>قسم</a></span>
     </a>
     ...
     <div class="modal-dialog" role="document">
       <div class="modal-content">
         <div class="modal-header">
           <h5 class="modal-title" id="add-productLabel"> اضافة قسم </h5>
...
<form action="ar_category.php" method="post">
  ...
  <input type="hidden" name="merch_id" value="<?php echo $merch_id;?>">
   ...
   <div class=" row input_group" >
          ...
          <textarea name="ar_description" rows="4" cols="30" required placeholder="الوصف"style="text-align: right;"></textarea>

            </div>
            <div class="col-md-6">

             <textarea name="description" required rows="4" cols="30" required placeholder=" Description"style="text-align: left;"></textarea>
            </div>

   </div>

             <div class="modal-footer ar_modal-footer">
      <input type="submit" class="btn btn-secondary" name="add_cat" value="اضافة"style="margin-bottom: 6px;">
...
<div class="rows">
  ...
  <div class="col">
    <div class="row info">
      ...
      <div class="col-md-12">
        <p><span class="title"><?php echo $value['nameAr'];?></span></p>
          <p style="color: #56524c;">
          <?php echo $value['descriptionAr'];?>
           </p>
      </div>
    </div>
  <div class="row" style="padding: 1px;justify-content: center;">
    <!--buttton of veiw product-->
      <form action="ar_product.php" method="POST">
        ...
        <button type="submit" name="product" class="btn btn-primary action ">المنتجات</button>
      </form>
      ...
      <div class="modal fade" id="<?php echo $value['id'];?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id'];?>Label" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="<?php echo $value['id'];?>Label">تعديل القسم  <?php echo " ".$value['nameAr'];?></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"style="margin:0;">
                <span aria-hidden="true" style="color: #ff1f00;">&times;</span>
              </button>
            </div>
          ...
          <form action="ar_category.php" method="post"class="edite_cat">
                <input type="hidden" name="merch_id" value="<?php echo $merch_id;?>">
                <input type="hidden" name="cat_id" value="<?php echo $value['id'];?>">
                <div class=" row input_group">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="name" value="<?php echo $value['nameAr'];?>"required>
            <label>:New Name</label>
              ...
              <div class=" row input_group" style="margin-left: 40px;">
                    ...
                    <div class="col-md-6"style="margin-left: 0px;">
                     <textarea name="ar_description" rows="4" cols="30" required placeholder="تحرير الوصف " style="text-align:right;"><?php echo $value['descriptionAr'];?></textarea>
                    </div>
                    <div class="col-md-6">
                     <textarea name="description"  rows="4" cols="30" required placeholder="New Description"style="text-align:left;"><?php echo $value['description'];?></textarea>
                    </div>

              </div>
                <div class="modal-footer ar_modal-footer">
                  <input type="submit" class="btn btn-secondary" name="edite" value="حفظ التغييرات ">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">الغاء</button>
      ...
      <div class="modal fade" id="<?php echo $value['id'];?>delet" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id'];?>Labeldelet" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="<?php echo $value['id'];?>Labeldelet">حذف القسم</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"style="margin:0;">
                <span aria-hidden="true" style="color: #ff1f00;">&times;</span>
              </button>
            </div>
            <div class="modal-body Ar_body" style="font-size: 19px;">
              <p style="color: azure;">  حذف القسم <span style="color: #009688;"> <?php echo $value['nameAr'];?></span> هل انت  متأكد !؟</p>
...
{?>
 <div class="layout">
 <div class="success">
   <p>تمت اضافة القسم <span style="color: #5a1c08;" ><?php echo " ".$ar_name." " ; ?></span> بنجاح</p>
      <a href="ar_category.php" class="btn btn-secondary add_ok">تم</a>
 </div>
</div>
<?php
}
   ...
   <div class="success">
     <p> <?php echo $response?></p>
        <a href="ar_category.php" class="btn btn-secondary add_ok">رجوع</a>
   </div>
 </div>
 <?php
 }
...
{?>
 <div class="layout">
 <div class="success">
   <p>تم تعديل القسم <span style="color: #5a1c08;" ><?php echo " ".$_POST['nameAr']." " ; ?></span> بنجاح</p>
      <a href="ar_category.php" class="btn btn-secondary add_ok">تم</a>
 </div>
</div>
<?php
...
{?>
 <div class="layout">
 <div class="success">
   <p>تم حذف القسم <span style="color: #5a1c08;" ><?php echo " ".$name." " ; ?></span> بنجاح</p>
      <a href="ar_category.php" class="btn btn-secondary add_ok">تم</a>
 </div>
</div>
<?php
