...
<span class="link" style="display:none;">ArabicBages/ar_services.php</span>
<style media="screen">
  .services {
...
<div class="auto-margin">
  <div class="Customer-header">
    <h3>Services</h3>
    <span class="count"> There Are <span class="cnumb"><span style="color: #e55508;"><?php echo count($service); ?></span></span> service</span>
    ...
    <a class=" add" data-toggle="modal" data-target="#add-product">
      ...
      <span style="position:relative"> Add<i class="fas fa-plus-circle"></i>Service</span>
    </a>
  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content add_serv">
        <div class="modal-header">
          <h5 class="modal-title" id="add-productLabel">Add Service </h5>
          ...
          <form action="post" enctype="multipart/form-data" name="form" id="formElem">
            ...
            <div class=" row input_group">
              ...
              <div class="col-md-5">
                ...
                <input type="text" class="titleAr" name="titleAr" required>
              </div>
            </div>
            ...
            <div class="modal-footer">
              <input type="submit" class="btn btn-secondary view addservice" name="addservice" value="Add">
  ...
  <div>
    ...
    padding-left: 15px;">
                  ...
                  <div class="modal fade" id="<?php echo $value['id']; ?>delet" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>deletLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content" style="margin-top: 67px;">
                        <div class="modal-header">
                          <h5 class="modal-title" id="<?php echo $value['id']; ?>deletLabel">Delet Service </h5>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span style="color: #c7421b;" aria-hidden="true" style="color: #ff1f00;">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body" style="font-size: 19px;">
                          <p>Delet Service<span style="color: #009688;"> <?php echo $value['title']; ?></span> Are you sure!?</p>
                  ...
                  <!-- Modal -->
                  <div class="modal modal-veiw fade" id="<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>req" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                              ...
                              <?php foreach ($value['serviceRequests'] as $value) { ?>
                                <tr>
                                  ...
                                  <td scope="row">
                                    ...
                                    <button type="button" class="btn btn-primary  show-delet-req" data-toggle="modal" data-target="#<?php echo $value['id']; ?>del" style="background: transparent;border: none;">
                                    ...
                                    <div class=" modal modal-dismiss fade" id="<?php echo $value['id']; ?>del" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>delLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="<?php echo $value['id']; ?>delLabel">Delet Service Request </h5>

                                          </div>
                                          <div class="modal-body" style="font-size: 19px;">
                                            <p>Delet Request Of<span style="color: #009688;"> <?php echo $value['clientName']; ?></span> Are you sure!?</p>

                                            <form action="delet_service_req.php" method="post">
                                              <input type="hidden" name="id" value="<?php echo $value['id']; ?>">
    ...
    ?>
        ...
        <div class=" add-success success">
          ...
          <p>Service<span style="color: #5a1c08;"><?php echo " " . $name . " "; ?></span>Deleted successfuly</p>
          <a href="services.php" class="btn btn-secondary add_ok">OK</a>
      ...
      <?php
        ...
        <div class="success add-success">
          ...
          <a href="services.php" class="btn btn-secondary add_ok">Back</a>
        ...
        axios.post("https://alrawaj.herokuapp.com/api/v1/service", formData, {
          ...
          .then(res => {
            if (res.data.status == true) {
              window.alert("Serivce Added Successfuly");
              location.reload();
            } else {
