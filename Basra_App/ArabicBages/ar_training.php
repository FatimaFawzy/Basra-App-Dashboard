...
<body  >
  ...
  <span class="link" style="display:none;">../training.php</span>
  ...
  <div class="auto-margin Ar_auto-margin">
    <div class="Customer-header">
      <h3>التدريبات</h3>
      <span class="count"> يوجد<span class="cnumb"><span style="color: #e55508;"><?php echo count($service); ?></span></span> تدريب</span>
      ...
      <a class=" add" data-toggle="modal" data-target="#add-product">
        ...
        <span style="position:relative"> اضافة<i class="fas fa-plus-circle"></i>تدريب</span>
      </a>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content add_serv">
          <div class="modal-header">
            <h5 class="modal-title" id="add-productLabel">اضافة تدريب </h5>
    ...
    <div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="row" style="    margin-right: 20px;">
                    ...
                    <!-- delet service-->
                    <button type="button" class="btn btn-primary view" data-toggle="modal" data-target="#<?php echo $value['id']; ?>delet" style="margin-right: -27px;padding-right:15px;">
                    ...
                    <div class="modal fade" id="<?php echo $value['id']; ?>delet" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>deletLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content" style="margin-top: 67px;">
                          <div class="modal-header">
                            <h5 class="modal-title" id="<?php echo $value['id']; ?>deletLabel">حذف التدريب </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin:0;">
                              <span style="color: #c7421b;" aria-hidden="true" style="color: #ff1f00;">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body" style="font-size: 19px;">
                            <p>حذف التدريب<span style="color: #009688;"> <?php echo $value['titleAr']; ?></span> هل انت تأكد!؟</p>

                            <form action="ar_training.php" method="post">
                              <input type="hidden" name="id" value="<?php echo $value['id']; ?>">
                              <input type="hidden" name="name" value="<?php echo $value['titleAr']; ?>">
                              <div class="modal-footer ar_modal-footer delet">
                    ...
                    <div class="modal fade" id="<?php echo $value['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>req" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content req">
                          <div class="modal-header">
                            <h5 class="modal-title" id="<?php echo $value['id']; ?>req">عرض طلبات
                                      ...
                                      <div class="modal   modal-dismiss fade" id="<?php echo $value['id']; ?>del" tabindex="-1" role="dialog" aria-labelledby="<?php echo $value['id']; ?>delLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <h5 class="modal-title" id="<?php echo $value['id']; ?>delLabel">حذف طلب التدريب </h5>

                                            </div>
                                            <div class="modal-body" style="font-size: 19px;">
                                              <p> حذف طلب<span style="color: #009688;"> <?php echo $value['clientName']; ?></span>هل انت متأكد!؟</p>

                                              <form action="ar_delet_trainig_req.php" method="post">
                                                <input type="hidden" name="id" value="<?php echo $value['id']; ?>">
      ...
      ?>
          ...
          <div class="success add-success">
            ...
            <p>تم حذف التدريب<span style="color: #5a1c08;"><?php echo " " . $name . " "; ?></span>بنجاح</p>
            <a href="ar_training.php" class="btn btn-secondary add_ok">تم</a>
        ...
        <?php
          ...
          <div class="success add-success">
            ...
            <a href="ar_training.php" class="btn btn-secondary add_ok">رجوع</a>
          ...
          axios.post("https://alrawaj.herokuapp.com/api/v1/training", formData, {
            ...
            .then(res => {
              if (res.data.status == true) {
                window.alert("تمت اضافة التدريب بنجاح");
                location.reload();
              } else {
