...
<span class="link" style="display:none;">ArabicBages/ar_edite_marchent.php</span>
<form class="form" action="ArabicBages/ar_edite_marchent.php"method="POST"style="left: 86%;">
...
<div class="add-merchent ">
  <h1> Edit Merchants<?php echo " ".$march_name;?></h1>
<form action="edite_marchent.php" method="post">
  <input type="hidden" name="march_id" value="<?php echo $march_id;?>">
    <input type="hidden" name="march_name" value="<?php echo $march_name;?>">
 <div class="row">
  <div class=" col-md-12">
  ...
  <div class="row disc input-group">
    ...
    <div class="col-md-6">
      <label class="input-label" >New Arabic Discription:</label>
          <textarea name="ar_discription" rows="5" cols="25"></textarea>
    </div>
  </div>
  ...
  <div class="row input-group">
    ...
    <div class="col-md-12 " style="margin-top: 50px;">
      <label class="input-label" >Arabic Store Type :</label><br>
...
{?>
  <div class="success">
    <p>merchent Edited successfuly</p>
       <a href="merchants.php" class="add_ok">OK</a>
  </div>
<?php
}
else{?>
    <div class="success">
      <p> <?php echo $response?></p>
        ...
        <a href="merchants.php" class="add_ok">Back</a>
    </div>
  <?php
  }
}
